...
Step 2. Download the Ubuntu/Debian .ISO image to your local build environment via whatever method you prefer (Web Browser, etc)
...
We assume that the URL can be broken into 2 parts: \<image-url-prefix\>/\<bare-metal-custom-debian-iso\>
...
hpe-preseed.cfg.template         | The core DebianInstaller Preseed file (templated with hostdef-v[latest])
